...
This is a patch release focused on repository-wide editorconfig conventions, compatible dependency upgrades, and a consolidated Docker test environment.

### Added

- Root `.editorconfig` conventions for UTF-8 encoding, LF line endings, indentation, and analyzer and IDE defaults.

### Changed

- All NuGet dependencies upgraded to the latest compatible versions: Codebelt.Extensions.Swashbuckle.AspNetCore from 10.2.4 to 10.2.5, Codebelt.Extensions.Xunit.App from 11.1.2 to 11.2.1, Cuemon.Core and Cuemon.Extensions.Hosting from 10.5.5 to 10.7.0, Microsoft.NET.Test.Sdk from 18.8.1 to 18.9.0, net9 Microsoft.AspNetCore and Microsoft.Extensions packages from 9.0.18 to 9.0.19, and net10 equivalents from 10.0.10 to 10.0.11,
- Docker test environments consolidated from separate net9 and net10 runner images to the shared `codebeltnet/ubuntu-testrunner:8-9-10-11` image.
